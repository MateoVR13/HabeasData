...
const Slide3: React.FC = () => {
    return (
        <div className="h-full w-full flex flex-col items-center justify-center p-8 animate-fade-in">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-8 rounded-xl max-w-4xl w-full shadow-2xl animate-zoom-in" style={{animationDelay: '400ms'}}>
                 ...
                 <div className="border-l-4 border-cyan-500 pl-6 py-2 bg-slate-900/50 rounded-r-lg">
